...
function check()
{
  ...
  while(RS_result.next()){
   ...
   <tr><td>日期：</td><td><input type="text" name='shijian' value='<%=shijian%>'  id='shijian'></input></td></tr>
   <tr><td>用户id：</td><td><input type="text" name='uid' value='<%=uid%>'  id='uid'></input></td></tr>
   <tr><td>用户姓名：</td><td><input type="text" name='xingming' value='<%=xingming%>'  id='xingming'></input></td></tr>
