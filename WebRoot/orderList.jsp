  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"> 订单号 </span></div></td>
        <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"> 商家 </span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">  订单内容  </span></div></td>
        <td width="16%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">  联系方式 </span></div></td>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"> 账单状态</span></div></td>
      ...
      <%
		...
		%>
		      <tr>
		        ...
		        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"> <%=order.getFood_id()%> </div></td>
		        ...
		        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"> 
		         		<a href="order.do?method=update&id=<%=order.getId()%>&state=1">已发货</a>   
		         		<a href="order.do?method=update&id=<%=order.getId()%>&state=0">未发货</a>   
...
以上数据共<%=list.size() %>条,<a style="cursor:hand" onClick="javascript:window.print();">打印本页</a>
</html>