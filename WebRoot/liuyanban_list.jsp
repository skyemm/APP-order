...
<html>
  <head>
    ...
    <title>留言板记录</title><LINK href="inc/style.css"  type=text/css 
rel=stylesheet>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    <td width="30" align="center" bgcolor="CCFFFF">序号</td>
        	...
        	<td bgcolor='#CCFFFF'>用户id</td>  
        	<td bgcolor='#CCFFFF'>用户姓名</td>  
...
%>
  <tr>
    ...
    <td width="60" align="center"><a href="liuyanban_updt.jsp?id=<%=id%>">修改</a>  <a href="del.jsp?id=<%=id %>&tablename=liuyanban" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
