...
public final class liuyanban_005fupdt_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>留言板记录</title><script language=\"javascript\" src=\"js/Calendar.js\"></script>\r\n");
      ...
      out.write("\tif(document.form1.shijian.value==\"\"){alert(\"请输入日期\"); document.form1.shijian.focus();return false;}\r\n");
      out.write("\tif(document.form1.uid.value==\"\"){alert(\"请输入用户id\"); document.form1.uid.focus();return false;}\r\n");
      out.write("\tif(document.form1.xingming.value==\"\"){alert(\"请输入用户姓名\"); document.form1.xingming.focus();return false;}\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("  <body >\r\n");
      out.write("  ");
  ...
  String id=request.getParameter("id");
      ...
      out.write("\r\n");
      out.write("  <form name=\"form1\" id=\"form1\" method=\"post\" action=\"liuyanban_updt_post.jsp?id=");
      out.print(id );
      out.write("\">\r\n");
      out.write("  修改留言板记录:\r\n");
      out.write("  <br><br>\r\n");
  ...
  while(RS_result.next()){
      ...
      out.write("   <tr><td>日期：</td><td><input type=\"text\" name='shijian' value='");
      out.print(shijian);
      out.write("'  id='shijian'></input></td></tr>\r\n");
      out.write("   <tr><td>用户id：</td><td><input type=\"text\" name='uid' value='");
      out.print(uid);
      out.write("'  id='uid'></input></td></tr>\r\n");
      out.write("   <tr><td>用户姓名：</td><td><input type=\"text\" name='xingming' value='");
      out.print(xingming);
      out.write("'  id='xingming'></input></td></tr>\r\n");
      out.write("\t \r\n");
      out.write("    <tr>\r\n");
      out.write("      <td>&nbsp;</td>\r\n");
