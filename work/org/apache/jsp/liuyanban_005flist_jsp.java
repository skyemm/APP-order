...
public final class liuyanban_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>留言板记录</title><LINK href=\"inc/style.css\"  type=text/css \r\n");
      ...
      out.write("        \t<td bgcolor='#CCFFFF'>日期</td>  \r\n");
      out.write("        \t<td bgcolor='#CCFFFF'>用户id</td>  \r\n");
      out.write("        \t<td bgcolor='#CCFFFF'>用户姓名</td>  \r\n");
      out.write("    \r\n");
 ...
 while(RS_result.next()){
	 ...
	 id=RS_result.getString("id");  
      ...
      out.write("</td> \r\n");
      out.write("        \t<td>");
      out.print(RS_result.getString("uid"));
      out.write("</td> \r\n");
      out.write("        \t<td>");
      out.print(RS_result.getString("xingming"));
      out.write("</td> \r\n");
      out.write("    \r\n");
      out.write("    <td width=\"60\" align=\"center\"><a href=\"liuyanban_updt.jsp?id=");
      out.print(id);
      out.write("\">修改</a>  <a href=\"del.jsp?id=");
      out.print(id );
      out.write("&tablename=liuyanban\" onClick=\"return confirm('真的要删除？')\">删除</a></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  \t");
