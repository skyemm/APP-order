...
public final class huodong_005fupdt_005fpost_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sql="update   huodong set " +
   				...
   				" shijian ='" + request.getParameter("shijian") +  "' where id=" + request.getParameter("id");

connDbBean.executeUpdate(sql);
out.print("<script>alert('�޸ĳɹ�!!');location.href='huodong_list.jsp';</script>");
