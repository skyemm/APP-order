...
public class HuodongAction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (method.equals("list")) {
		    ...
		    if (type != null && type.equals("json")) {
				...
				getAll(req, dao);
				req.getRequestDispatcher("/huodonglist.jsp").forward(req, resp);
			}
			...
			req.getRequestDispatcher("/huodong_update.jsp").forward(req, resp);	    
		    
		} else if (   method.equals("update") ){
 
			String id = req.getParameter("id");
			Huodong object  = dao.getObjectById(id) ;
			...
			String result = "" ;
			String parameter = req.getParameter("huodong");
			try {
	...
	private void getAllForUpdate(HttpServletRequest req, HuodongDao dao) {
	...
	private void getAll(HttpServletRequest req, HuodongDao dao) {
